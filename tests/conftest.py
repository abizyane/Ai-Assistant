...
class FakeLLM:
    async def generate(self, request):
        ...
        return GenerationResult(text="", input_tokens=0, output_tokens=0, model="fake", finish_reason="stop")
...
def _reset_contextvars_and_di() -> None:
    ...
    try:
        from src.shared.tracing import current_trace_id, current_session_id

...
_EXPECTED_KEYS = {
    "app_title", "app_subtitle", "nav_chat", "nav_ingest", "nav_sessions", "nav_eval",
    "sidebar_language", "sidebar_session_id_label", "sidebar_session_id_empty",
    "sidebar_clear", "sidebar_new_session", "chat_input_placeholder", "chat_thinking",
    "chat_no_messages", "citations_expander", "citation_source", "citation_page",
    "citation_score", "langfuse_trace", "ingest_title", "ingest_upload_label",
    "ingest_button", "ingest_success", "ingest_error", "sessions_title",
    "sessions_select", "sessions_no_sessions", "sessions_role_user",
    "sessions_role_assistant", "eval_title", "eval_no_runs", "eval_metric_score",
    "eval_threshold", "eval_docs_link", "error_api_unavailable", "error_generic",
